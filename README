...
###Project Phases:
Data Collection: Integrated data from customer databases, transactional records, and demographic attributes.

Data Cleaning & Preparation: Removed duplicates, corrected errors, and structured datasets using aggregation and transformation techniques.

Visualization Development: Built interactive dashboards using Tableau to present multi-dimensional insights through bar charts, pie charts, scatterplots, and heat maps.

Insight Generation: Delivered actionable recommendations to enhance customer segmentation, predict purchasing behavior, and improve overall customer experience.
